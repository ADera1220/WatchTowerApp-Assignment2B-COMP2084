...
namespace WatchTowerWebApp.Controllers
{
    ...
    public class ServicesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Type,Platform,RenewalDate")] Service service)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Type,Platform,RenewalDate")] Service service)
        {
            if (id != service.Id)
            {
                return NotFound();
